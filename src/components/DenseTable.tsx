    ...
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
        ...
        <TableRow style={{ background: '#4ac776' }}>
            ...
            <TableCell align="right" style={{ fontSize: '1.5rem', fontWeight: 'bold', color: 'white' }}>Artist</TableCell>
            <TableCell align="right" style={{ fontSize: '1.5rem', fontWeight: 'bold', color: 'white' }}>Album</TableCell>
            <TableCell align="right" style={{ fontSize: '1.5rem', fontWeight: 'bold', color: 'white' }}>Play Song</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="right"style={{ fontSize: '1.2rem', color: 'black' }}>{row.artist}</TableCell>
              <TableCell align="right"style={{ fontSize: '1.2rem', color: 'black' }}>{row.album}</TableCell>
